...
define('DB_PASS', 'quexf123');
define('DB_HOST', 'localhost');
define('DB_NAME', 'quexf');
define('ADODB_DIR', '/survey/htdocs/quexf/software/adodb5/');
define('TESSERACT_BIN', "/survey/htdocs/quexf/software/tesseract-ocr/tesseract.exe");
define('CONVERT_BIN', "/survey/htdocs/quexf/software/ImageMagick/convert.exe");
//REQUIRED: Ghostscript binary
define('GS_BIN', "/survey/htdocs/quexf/software/gs/bin/gswin32c.exe");
//Temporary directory
